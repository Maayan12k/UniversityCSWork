 ...
 * This version supports interpolation of a polynomial that passes through the given points.
 */
        ...
        for (double exponent : polynomial.keySet()) {
            ...
            if (exponent == 0) {
                if (coefficient == 1.0) {
                    ...
                    if (++index == size)
                        System.out.print(new BigDecimal(coefficient).setScale(2, RoundingMode.HALF_UP).doubleValue());
                    else
                        System.out.print(
                                new BigDecimal(coefficient).setScale(2, RoundingMode.HALF_UP).doubleValue() + " + ");
                }
            } else if (exponent == 1) {
                if (coefficient == 1.0) {
                    if (++index == size)
                    ...
                    if (++index == size)
                        System.out.print(
                                new BigDecimal(coefficient).setScale(2, RoundingMode.HALF_UP).doubleValue() + "x");
                    else
                        System.out.print(
                                new BigDecimal(coefficient).setScale(2, RoundingMode.HALF_UP).doubleValue() + "x + ");
                }
