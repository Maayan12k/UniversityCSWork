 ...
 * 
 *
 * The compiler operates on a given source, where source is either a file name
 * of the form Xxx.jack or a directory name containing one or more such files.
 * For each Xxx . jack input file, the compiler creates a JackTokenizer and an
 * output Xxx.vm file.
 * Next, the compiler uses the CompilationEngine, SymbolTable, and VMWriter
 * modules to write the output file.
 */
