...
public class CompilationEngine {
    ...
    public CompilationEngine(File inFile, File outFile, File outTokenFile) throws FileNotFoundException {
    ...
    private void compileClassVarDec() {
        ...
        if (tokenizer.keyWord() == JackTokenizer.CONSTRUCTOR || tokenizer.keyWord() == JackTokenizer.FUNCTION
    ...
    private void compileSubroutine() {
        ...
        if (tokenizer.tokenType() != JackTokenizer.KEYWORD || (tokenizer.keyWord() != JackTokenizer.CONSTRUCTOR
                && tokenizer.keyWord() != JackTokenizer.FUNCTION && tokenizer.keyWord() != JackTokenizer.METHOD)) {
