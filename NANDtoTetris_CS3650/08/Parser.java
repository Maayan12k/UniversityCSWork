...
public class Parser {
    ...
    // currentCommand is.
    public String arg1() {
        if (currentCommandType.equals("C_POP"))
            return currentCommand.substring(4, currentCommand.indexOf(" ", 4));

        else if (currentCommandType.equals("C_PUSH"))
            return currentCommand.substring(5, currentCommand.indexOf(" ", 5));

        else if (currentCommandType.equals("C_ARITHMETIC"))
            return currentCommand;

        else if (currentCommandType.equals("C_LABEL") || currentCommandType.equals("C_GOTO")
                || currentCommandType.equals("C_IF"))
