public static void main(String[] args) throws IOException {
    SortedPriorityQueue<Integer, Integer> list1 = new SortedPriorityQueue<>();
    ...
    System.out .println("Runtime(Milliseconds) to sort 1000 element text file: " + ((endTime - startTime) / 1000000));
    for (int i = 0; i < 995; i++) {
        if (i < 5) {
            System.out .print(list2.removeMin().getKey() + " ");
        } else list2.removeMin();
    }
    System.out .println();
    for (int i = 0; i < 5; i++) {
        System.out .print(list2.removeMin().getKey() + " ");
